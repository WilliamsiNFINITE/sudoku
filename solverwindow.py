...
class Ui_SolverWindow(object):
    ...
    def solve(self):
        self.updateBoard()
        print("selfboard",self.board)
        generatedBoard = array(solveGen(self.board, self.hauteur, self.largeur)[0])
        print("generated board", generatedBoard, "type", type(generatedBoard))
    ...
    def setupUi(self, MainWindow, hauteur = 3, largeur=3, case="Empty"):
        print(case)
        ...
        if case == 'Solution':
            print("la il essaye")
            print("notamment avec le board", self.boardSolver)
            generatedBoard = array(solveGen(self.boardSolver, 3, 3)[0]) #DIMENSION
            print("generated board", generatedBoard, "type", type(generatedBoard))
        ...
        for i in range(self.dimension):  # hauteur
            ...
            for j in range(self.dimension):
                ...
                if ((i // self.largeur) + (j // self.hauteur)) % 2 == 0:
                ...
                if case != "Solution":
                    ...
                    self.boxes[(i, j)].setPlainText(str(generatedBoard[i][j]))
